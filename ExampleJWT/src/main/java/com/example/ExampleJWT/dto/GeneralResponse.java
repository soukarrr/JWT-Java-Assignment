package com.example.ExampleJWT.dto;
...
public class GeneralResponse implements Serializable {
    ...
    public ResponseEntity<GeneralResponse> response(int code, String message, HttpStatus status,String token) {
        this.code = code;
        this.message = message;
        this.token = token;
        this.total = 0;
    ...
    public ResponseEntity<GeneralResponse> response(Object data,HttpStatus status,String token) {
        this.code = 200;
        this.message = "Operation Success";
        this.total = 1;
        this.data = data;
